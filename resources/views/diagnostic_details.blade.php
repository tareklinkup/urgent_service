                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-4 col-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="diagnostic_name" id="diagnostic_name" class="form-control" autocomplete="off" style="height: 33px;border-radius: 2rem;background: black;border: 0;box-shadow: none;color: #a3a3a3;padding-left: 18px;padding-top: 3px;">
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: res => {
                if (res.status == true && res.message.length == 0) {
                    ...
                    $(".diagnosticbody").html(`<div class="col-12 bg-dark text-white text-center">${res.message}</div>`)
                }
            },
            complete: () => {
