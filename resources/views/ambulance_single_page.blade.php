...
<section id="appointment" style="padding: 25px 0;">
    <div class="container">
        ...
        <div class="newsletter">
            <div class="card mt-1">
                <div class="card-header" style="background: #023256;">
                    <h4 class="text-white">Hire An Ambulance</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group my-2">
                                    <label for="ambulance_type">Ambulance Type: <span class="text-danger">*</span></label>
        ...
        <div class="appointment-banner">
            <h2 class="text-light">AC Ambulance:- {{$data->phone}}</h2>
        </div>
        @endif
