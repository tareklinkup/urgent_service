...
@section("title", "Diagnostic Dashboard")
...
<div class="row d-flex justify-content-center">
    <div class="col-md-3 col-lg-3 col-xlg-3">
        <a href="{{route('diagnostic.doctor.index')}}" class="text-decoration-none">
    ...
    <div class="col-md-3 col-lg-3 col-xlg-3">
        <a href="{{route('diagnostic.appointment')}}" class="text-decoration-none">
            <div class="card" style="position: relative;">
    ...
    <div class="col-md-3 col-lg-3 col-xlg-3">
        <a href="{{route('diagnostic.appointment.today')}}" class="text-decoration-none">
            <div class="card" style="position: relative;">
