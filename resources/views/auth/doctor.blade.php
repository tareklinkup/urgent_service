...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" id="doctor">
            ...
            <button type="submit" class="btn mt-3">Doctor</button>
        </form>

        <form class="p-3 mt-3 d-none" id="hospital">
            <div class="form-field d-flex align-items-center">
                <i class="far fa-user"></i>
                <input type="text" name="email" id="email" placeholder="Email">
            </div>
        ...
        <form class="p-3 mt-3 d-none" id="diagnostic">
            <div class="form-field d-flex align-items-center">
                <i class="far fa-user"></i>
                <input type="text" name="email" id="email" placeholder="Email">
            </div>
            ...
            <button type="submit" class="btn mt-3">Diagnostic</button>
        </form>
        <form class="p-3 mt-3 d-none" id="ambulance">
            <div class="form-field d-flex align-items-center">
                <i class="far fa-user"></i>
                <input type="text" name="email" id="email" placeholder="Email">
            </div>
            ...
            <button type="submit" class="btn mt-3">Ambulance</button>
        </form>
        ...
        $(document).ready(() => {
            ...
            $("#doctor").on("submit", (event) => {
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: () => {
                        $("#doctor").find(".error").text("");
                    },
                    success: (response) => {
                        if (response.error) {
                            $.each(response.error, (index, value) => {
                                $("#doctor").find(".error-" + index).text(value);
                            })
